package com.example.weatherappmvvm_livedata_retrofit_dagger_hilt.view_model
...
import com.example.weatherappmvvm_livedata_retrofit_dagger_hilt.repository.WeatherRepository
    ...
    private fun getWeather() = viewModelScope.launch {
        repository.getWeather().let { response ->
            if (response.isSuccessful){
                ...
                Log.d("TAG", "getWeather response error ${response.message()}")
            }
        }
    }
}